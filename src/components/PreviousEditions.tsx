...
const videos: VideoItem[] = [
    ...
    {
        id: "loop-di-loop-2025",
        title: "Loop-Di-Loop 2025",
        year: "2025",
        youtubeId: "3jIYPgJ_j08",
    },
    {
        id: "dbb-2023-tag-team-finals",
                        ...
                        <div className="embla__container flex">
                            {videos.map((video, index) => {
                                ...
                                return (
                                    ...
                                    >
                                        <div
                                            className={`relative aspect-video rounded-2xl overflow-hidden bg-black transition-all duration-500 ${isSelected
                                        ...
                                        >
                                            {isActive ? (
                                                ...
                                                <>
                                                    ...
                                                    {/* Orange subtle glow */}
                                                    <div className="absolute inset-0 bg-[#FF6B00]/10 mix-blend-screen pointer-events-none" />
                                                    ...
                                                    <div className="absolute bottom-6 left-6 right-6 pointer-events-none">
                                                        <p className="text-[#FF6B00] text-sm font-bold tracking-widest uppercase mb-2">
                                                            {video.year}
                                                        </p>
                    ...
                    <div className="flex justify-center gap-2 mt-8">
                        {videos.map((video, index) => (
                            <button
                                ...
                                aria-label={`Ga naar ${video.title}`}
